...
import { isDefined, isEmptyObject, isPlainObject, isPrimitive, isString } from './type';
 ...
 */
export const interpolate = (text, data, alternate = undefined, defaultValue = undefined) => {
	if (!text) return text;
	if (!data) return text;
...
// [['Code','=',1], "and", [['Code','=',1], "and", ['Code','=',1]] ]
export const addQueryFilter = (filter: FilterDescriptor, newVal: FilterDescriptor) => {
...
export const rolesAllowed = (userRoles: string | string[], itemRoles: string[]) => {
